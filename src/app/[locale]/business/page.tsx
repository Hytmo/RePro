...
export default async function BusinessPage({params}: {params: Promise<{locale: string}>}) {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      ...
      <Link href={user ? '/business/new' : '/sign-in'} className="mt-6 inline-block rounded-lg bg-brand-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-brand-700">
        {t('listCta')}
      </Link>
